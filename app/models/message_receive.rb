class MessageReceive < ActiveRecord::Base
	...
	def save_text(content, origin_source)
	...
	def save_image(pic_url, origin_source)
	...
	def save_location(label, location_x, location_y,  origin_source, scale)
	...
	def save_event(event, event_key, origin_source)
	...
	def save_voice(format, media_id, recognition, region_source)
	...
	def save_link(description, origin_source, title, url)
